...
from JarnikPrim import JarnikPrim
...
def defineGraph() -> tuple[nx.Graph, dict[str, Point], dict[tuple[str, str], str]]:
    ...
    edgeListWithWeight:list[tuple[str,str,float]] = [
        ("v0","v1",3),("v0","v2",2),("v0","v3",3),
        ("v1","v2",1),("v1","v4",2),("v1","v5",1),("v1","v6",2),
        ("v2","v3",5),
        ("v3","v6",1),("v3","v9",1),
        ("v4","v5",1),("v4","v7",3),("v4","v8",3),                          
        ("v5","v8",1),
        ("v6","v8",2),
        ("v7","v8",2),
        ("v8","v9",1)]
    ...
    position:dict[str,Point]={
        "v0":Point(0.2,0.8),"v1":Point(0.2,0.6),"v2":Point(.4,.7),"v3":Point(.6,.8),
        "v4":Point(.2,.4),"v5":Point(.4,.5),"v6":Point(.6,.6),"v7":Point(.4,.3),
        "v8":Point(.6,.4),"v9":Point(.8,.6)}
    G = nx.Graph()
...
if __name__ == '__main__':
    ...
    T: list[tuple[str, str]] = JarnikPrim(G, "v0")
    drawGraph(G, position, edgeLabels, T)
    print('end')
